...
def MostrarGrupo(grupo):
    DirGrupos = {
        0: ['La', 'Ce', 'Pr', 'Nd', 'Pm', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er', 'Tm', 'Tb',
...
def GlosarioElementos(elemento):
    ...
    DicElementos = {
        'La': ['Lantano', 138.9, 920, 3454, 'Solid', '[Xe]5d^1*6s^2', '+3', 3, 57],
        'Ce': ['Cerio', 140.1, 798, 3257, 'Solid', '[Xe]4f^1*5d^1*6s^2', '+3,4', 4, 58],
        'Pr': ['Praseodimio', 140.9, 931, 3017, 'Solid', '[Xe]4f^3*6s^2', '+3', 5, 59],
        'Nd': ['Neodimio', 144.2, 1016, 3127, 'Solid', '[Xe]4f^4*6s^2', '+3', 6, 60],
        'Pm': ['Prometio', 147, 1042, 3000, 'Solid', '[Xe]4f^5*6s^2', '3', 7, 61],
        'Sm': ['Samario', 150.3, 1074, 1794, 'Solid', '[Xe]4f^6*6s^2', '+3,2', 2, 62],
        'Eu': ['Europio', 152.0, 822, 1529, 'Solid', '[Xe]4f^7*6s^2', '+3,2', 2, 63],
        'Gd': ['Gadolinio', 157.3, 1313, 3273, 'Solid', '[Xe]4f^7*5d^1*6s^2', '+3', 2, 64],
        'Tb': ['Terbio', 158.9, 1365, 3230, 'Solid', '[Xe]4f^9*6s^2', '+3,4', 2, 65],
        'Dy': ['Disprosio', 162.5, 1412, 2567, 'Solid', '[Xe]4f^10*6s^2', '+3', 2, 66],
        'Ho': ['Holmio', 164.9, 1474, 2700, 'Solid', '[Xe]4f^11*6s^2', '+3', 3, 67],
        'Er': ['Erbio', 167.3, 1529, 2868, 'Solid', '[Xe]4f^12*6s^2', '+3', 2, 68],
        'Tm': ['Tulio', 168.9, 1545, 1950, 'Solid', '[Xe]4f^13*6s^2', '+3,2', 2, 69],
        'Yb': ['Iterbio', 173.04, 819, 1196, 'Solid', '[Xe]4^14*6s^2', '+3,2', 2, 70],
        'Ac': ['Actinio', 227, 1050, 3200, 'Solid', '[Rn]6d^1*7s^2', '+3', 3, 89],
        'Th': ['Torio', 232, 1750, 4790, 'Solid', '[Rn]6d^2*7s^2', '+4', 4, 90],
        'Pa': ['Protactinio', 231.00, 1570, 4000, 'Solid', '[Rn]5f^2*6d^1*7s^2', '+5,4', 5, 91],
        'U': ['Uranio', 238.0, 1132, 3818, 'Solid', '[Rn]5f^3*6d^1*7s^2', '+6,3,4,5', 6, 92],
        'Np': ['Neptunio', 237, 640, 3900, 'Solid', '[Rn]5f^4*6d^1*7s^2', '+5,3,4,6', 7, 93],
        'Pu': ['Plutonio', 242, 641, 3232, 'Solid', '[Rn]5f^6*7s^2', '+4,3,5,6', 2, 94],
        'Am': ['Americio', 243, 994, 2607, 'Solid', '[Rn]5f^7*7s^2', '+3,4,5,6', 2, 95],
        'Cm': ['Curio', 247, 1340, 'N/A', 'Solid', '[Rn]5f^7*6d^1*7s^2', '+3', 2, 96],
        'Bk': ['Berquelio', 247, 986, 'N/A', 'Solid', '[Rn]5f^9*7s^2', '+3,4', 2, 97],
        'Cf': ['Californio', 251, 'N/A', 'N/A', 'N/A', '[Rn]5f^10*7s^2', '+3', 2, 98],
        'Es': ['Einstenio', 252, 'N/A', 'N/A', 'N/A', '[Rn]5f^11*7s^2', '+3', 2, 99],
        'Fm': ['Fermio', 257, 'N/A', 'N/A', 'N/A', '[Rn]5f^12*7s^2', '+3', 2, 100],
        'Md': ['Mendelevio', 256, 'N/A', 'N/A', 'N/A', '[Rn]5f^13*7s^2', '+3,2', 2, 101],
        'No': ['Nobelio', 259, 'N/A', 'N/A', 'N/A', '[Rn]5f^14*7s^2', '+2,3', 2, 102],
...
if  __name__ ==  '__main__':
   ...
   while(salida.upper() == 'Y'):
       ...
       while (GrupoInvalido):
           ...
           grupo = input("Introduzca el numero de grupo a consultar de la tabla periodica y [0] para elementos sin grupo: ")
           try:
               grupo =int(grupo)
